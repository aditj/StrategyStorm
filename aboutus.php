...
<div id="executive-team" class="container">
    ...
    <div class="row justify-content-center pad">
      <div class="card" style="width: 17rem;">
        <img class="card-img-top" src="./img/aboutus/manav.jpg" alt="Manav_Photo" />
        <div class="card-body">
          <h5>Manav Agrawal</h5>
      ...
      <div class="card" style="width: 17rem;">
        <img class="card-img-top" src="./img/aboutus/devesh.jpg" alt="Devesh_Photo" />
        <div class="card-body">
          <h5>Devesh Soni</h5>
      ...
      <div class="card" style="width: 17rem;">
        <img class="card-img-top" src="./img/aboutus/vishwas.jpg" alt="Vishwas_Photo" />
        <div class="card-body">
          <h5>Vishwas Mishra</h5>
    ...
    <div class="row justify-content-center pad">
      <div class="card" style="width: 17rem;">
        <img class="card-img-top" src="./img/aboutus/mithilesh.jpg" alt="Mithilesh_Photo" />
        <div class="card-body">
          <h5>Mithilesh Kohale</h5>
      ...
      <div class="card" style="width: 17rem;">
        <img class="card-img-top" src="./img/aboutus/utkarsh.jpg" alt="Utkarsh_Photo" />
        <div class="card-body">
...
<div id="advisory-team">
    ...
    <div class="row justify-content-center pad">
        ...
        <div class="card" style="width: 17rem;">
          <img class="card-img-top" src="./img/aboutus/nihar.jpg" alt="Nihar_Photo" />
          <div class="card-body">
            <h5>Nihar Lohiya</h5>
        ...
        <div class="card" style="width: 17rem;">
          <img class="card-img-top" src="./img/aboutus/ex5.jpg" alt="Shaswat_Photo" />
          <div class="card-body">
            <h5>Shaswat Shrivastava</h5>
